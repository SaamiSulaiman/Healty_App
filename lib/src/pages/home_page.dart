...
class _HomePageState extends State<HomePage> {
  ...
  Widget _header() {
    return Column(
      ...
      children: <Widget>[
        Text("Hallo,", style: TextStyles.title.subTitleColor),
        Text("Beban Keluarga", style: TextStyles.h1Style),
      ],
    ).p16;
  }
      ...
      children: <Widget>[
        Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              Text("Categori", style: TextStyles.title.bold),
              Text(
                "Liat Semua",
        ...
        SizedBox(
          ...
          child: ListView(
            ...
            children: <Widget>[
              _categoryCard("Kisah Perokok", "350 + Stores",
                  color: LightColor.green, lightColor: LightColor.lightGreen),
              _categoryCard("Kasus Covid - 19", "899 Doctors",
                  color: LightColor.skyBlue, lightColor: LightColor.lightBlue),
              _categoryCard("Pengguna Ganja", "500 + Doctors",
